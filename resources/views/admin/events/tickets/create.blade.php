                ...
                <div class="xl:col-span-2 bg-white rounded-2xl border border-slate-200 shadow-sm p-6 md:p-8 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="e.g. Early Bird, VIP Pass" class="w-full rounded-xl border-slate-200 focus:border-red-500 focus:ring-red-500 transition-colors">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="type" id="type" class="w-full rounded-xl border-slate-200 focus:border-red-500 focus:ring-red-500 transition-colors">
                                ...
                                <option value="team" {{ old('type') == 'team' ? 'selected' : '' }}>Team Registration</option>
                            </select>
                        </div>

                        <div id="team_size_container" style="{{ old('type') == 'team' ? '' : 'display: none;' }}">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="team_size" id="team_size" value="{{ old('team_size') }}" min="2" placeholder="e.g. 5" class="w-full rounded-xl border-slate-200 focus:border-red-500 focus:ring-red-500 pl-10 transition-colors">
                            </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3" placeholder="What does this ticket include?" class="w-full rounded-xl border-slate-200 focus:border-red-500 focus:ring-red-500 transition-colors">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative flex items-center">
                                ...
                                <input type="number" step="0.01" name="price" id="price" value="{{ old('price', '0.00') }}" required class="w-full rounded-xl border-slate-200 focus:border-red-500 focus:ring-red-500 pl-9 transition-colors text-lg font-semibold text-slate-900">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                <span class="absolute left-4 text-slate-500 font-semibold">₦</span>
                                <input type="number" step="0.01" name="strike_price" id="strike_price" value="{{ old('strike_price') }}" placeholder="Original price" class="w-full rounded-xl border-slate-200 focus:border-red-500 focus:ring-red-500 pl-9 transition-colors text-lg font-semibold text-slate-900">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="quantity_available" id="quantity_available" value="{{ old('quantity_available') }}" placeholder="Unlimited" class="w-full rounded-xl border-slate-200 focus:border-red-500 focus:ring-red-500 pl-10 transition-colors">
                            </div>
                            <p class="text-xs text-slate-400 mt-1.5">Leave empty for unlimited tickets.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 xl:gap-10">
                <div class="xl:col-span-1">
                    <div class="sticky top-24">
                        ...
                        <p class="text-sm text-slate-500 mt-2 leading-relaxed">Control exactly when this ticket goes on sale and who can see it.</p>
                    </div>
                </div>
                <div class="xl:col-span-2 bg-white rounded-2xl border border-slate-200 shadow-sm p-6 md:p-8 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="datetime-local" name="sales_start" id="sales_start" value="{{ old('sales_start') }}" class="w-full rounded-xl border-slate-200 focus:border-red-500 focus:ring-red-500 transition-colors">
                        </div>
                        <div>
                            <label for="sales_end" class="form-label">Sales End (Optional)</label>
                            <input type="datetime-local" name="sales_end" id="sales_end" value="{{ old('sales_end') }}" class="w-full rounded-xl border-slate-200 focus:border-red-500 focus:ring-red-500 transition-colors">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="access_type" id="access_type" class="w-full rounded-xl border-slate-200 focus:border-red-500 focus:ring-red-500 transition-colors">
                                <option value="public" {{ old('access_type') == 'public' ? 'selected' : '' }}>Public (Visible to everyone)</option>
                                <option value="invite_only" {{ old('access_type') == 'invite_only' ? 'selected' : '' }}>Invite Only (Hidden)</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-400 mt-1.5">Inactive tickets cannot be purchased.</p>
                        </div>
                    </div>
                </div>
            </div>
