    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-start">
      ...
      <div class="lg:col-span-3">
        ...
        <div class="text-center mt-6">
          ...
          <a href="https://wa.me/2348000000000?text=Hi,%20I%20need%20help%20registering%20for%20{{ urlencode($event->name) }}"
...
{{-- WhatsApp FAB --}}
<a href="https://wa.me/2348000000000?text=Hi,%20I%20need%20help%20with%20{{ urlencode($event->name) }}"
